const setting = [
  {
    setting: {
      ...
      shop_name: "HypeCrates",
      address: "59 Station Rd, Purls Bridge, United Kingdom",
      company_name: "HtmlLover ltd",
      vat_number: "47589",
      post_code: "2030",
      contact: "019579034",
      email: "HypeCrates@gmail.com",
      website: "HypeCrates-admin.vercel.app",
      default_currency: "€",
    ...
    setting: {
      ...
      home: {
        ...
        quick_delivery_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our HypeCrates shop and get some special offers. See Our latest discounted products from here and get a special discount.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem HypeCrates-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
        },
        ...
        daily_need_title: {
          en: "Get Your Daily Needs From Our HypeCrates Store",
          de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
        },
        daily_need_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our HypeCrates shop and get some special offers.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem HypeCrates-Shop und erhalten Sie einige Sonderangebote.",
        },
      ...
      about_us: {
        ...
        top_title: {
          en: "Welcome to our HypeCrates shop",
          de: "Willkommen in unserem HypeCrates-Shop",
        },
        top_description: {
      ...
      contact_us: {
        ...
        email_box_email: {
          en: "info@HypeCrates.com ",
          de: "info@HypeCrates.com",
        },
        email_box_text: {
      ...
      faq: {
        ...
        faq_one: {
          en: "How does the HypeCrates work?",
          de: "Wie funktioniert der HypeCrates?",
        },
        description_one: {
        ...
        faq_five: {
          en: "What is HypeCrates EC2 auto scaling?",
          de: "Was ist die automatische Skalierung von HypeCrates EC2?",
        },
        description_five: {
          en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
        ...
        faq_six: {
          en: "What are the benefits of using HypeCrates affliate?",

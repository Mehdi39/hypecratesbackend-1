...
const forgetPassword = async (req, res) => {
  ...
  if (!isAdded) {
    ...
    const body = {
      ...
      <p>A request has been received to change the password for your <strong>HypeCrates</strong> account </p>
        ...
        <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@HypeCrates.com</p>

        <p style="margin-bottom:0px;">Thank you</p>
        <strong>HypeCrates Team</strong>
             `,
    };
